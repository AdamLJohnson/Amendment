...
namespace Amendment.Repository.Migrations
{
    ...
    [Migration("20181216232336_AddedSettings")]
            ...
            modelBuilder.Entity("Amendment.Model.DataModel.SystemSetting", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, EnteredBy = -1, EnteredDate = new DateTime(2018, 12, 16, 23, 23, 35, 675, DateTimeKind.Utc), Key = "ShowDeafSigner", LastUpdated = new DateTime(2018, 12, 16, 23, 23, 35, 676, DateTimeKind.Utc), LastUpdatedBy = -1, Value = "1" },
                        new { Id = 2, EnteredBy = -1, EnteredDate = new DateTime(2018, 12, 16, 23, 23, 35, 676, DateTimeKind.Utc), Key = "ShowDeafSignerBox", LastUpdated = new DateTime(2018, 12, 16, 23, 23, 35, 676, DateTimeKind.Utc), LastUpdatedBy = -1, Value = "1" }
                    );
                });
